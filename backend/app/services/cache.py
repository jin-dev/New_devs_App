...
async def get_revenue_summary(property_id: str, tenant_id: str, month: int, year: int) -> Dict[str, Any]:
    ...
    """
    # Include tenant_id, month, and year in the key so different tenants
    # with the same property_id never share a cache entry, and different
    # months are cached independently.
